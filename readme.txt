...
Tags: backup, wordpress backup, backup.rocks, database backup, complete backup, wp backup, website backup, backuprocks, backup rocks, real-time backup, dropbox backup, files backup, site backup, complete backup, offline backup, backup plugin, VaultPress, blogVault
...
backup.rocks is a unique & reliable automatic real time backup service for your WordPress site. We provide both free & paid subscriptions.

== Description ==

An all new unique, reliable and a real-time backup service for your websites, which can backup changes on your websites occurring even million times in a second! Call it as creating a clone-website of your real one, so that you never miss out any data ever!
...
After filling this information click on 'Purchase'. You will then be asked to enter your card details for the purchase (if you have selected one of the premium plans). After a successful payment, it will provide you with a license key and a link to download the plugin. (You don't need to download it again, as you have already done so in above steps.). Copy the license key and then go to your website admin panel and click on [backup.rocks](https://backup.rocks) menu. Paste your key and click on save. You will now see the 'Save' button changed to 'Activate License'. Click on 'Activate License'. That's it! :). After a few minutes, you can login to [backup.rocks](https://backup.rocks) dashboard to see your [backup.rocks](https://backup.rocks) in action!
